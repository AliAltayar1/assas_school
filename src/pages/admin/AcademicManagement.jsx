...
export function AcademicManagement() {
  ...
  const tabs = [
    ...
    {
      id: "levels",
      label: "الصفوف والمراحل",
      icon: Grid,
      component: GradeLevelsTab,
    },
    {
      id: "sections",
      label: "الشعب الصفية",
    ...
    {
      id: "grade_subjects",
      label: "مواد الصفوف (الخطة)",
      icon: Bookmark,
      component: GradeSubjectsTab,
    },
  ];

  const ActiveComponent =
    tabs.find((t) => t.id === activeTab)?.component || YearsTab;
    ...
    <div className="space-y-6 text-right dir-rtl" dir="rtl">
      ...
      <div className="border-b border-slate-200 pb-4">
        ...
        <p className="text-xs text-slate-500 mt-1">
          تهيئة وإدارة السنوات الدراسية والفصول والصفوف والشعب والمواد الدراسية
          للمدرسة.
        </p>
      </div>
